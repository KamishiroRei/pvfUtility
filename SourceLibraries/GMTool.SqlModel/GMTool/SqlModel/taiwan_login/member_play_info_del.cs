...
[SugarTable("member_play_info_del")]
public class member_play_info_del
{
	...
	public short used_fatigue { get; set; }

	public string ip { get; set; }

	public int last_play_time { get; set; }

	public byte pcbang_flag { get; set; }

	public string end_ip { get; set; }

	public short ting_count { get; set; }
