...
已验证边界：当前主目标实机样本证明，NPC 商店 stackable 商品会读取该字段显示金币价格，购买后扣除金币并发放道具。
...
已验证边界：当前主目标实机样本证明，NPC 商店 stackable 商品可读取该字段作为材料兑换条件，购买后消耗材料并发放目标道具。
...
已验证边界：当前主目标实机样本证明，将目标道具的堆叠上限从 1 提高后，可在商店继续购买第二个同道具，并与副本门票数量检查配合。
